...
async function sendBulkSms(data234){
    try {
        ...
        const data =response.msg
        // JSON.parse(data)
        const sharp_data=JSON.parse(data)
        console.log(sharp_data.message)
        // if (sharp_data.message.toString()=`['400 : "{"statusCode":400,"timestamp":1725885167641…nce","description":"uri=/billing/wallet/debitz"}"']`){
        //     alert_msg("insuffisient balance","red")
        // }
    } catch (error) {
        console.log(error)
    }
